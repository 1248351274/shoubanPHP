<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\Users\Administrator\Desktop\work\wxshop/application/index\view\img\type_show.html";i:1528954555;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="td-manage">
                ...
                <a title="编辑"  onclick="x_admin_show('编辑','<?php echo url("index/img/typedit",['id'=>$vo['GT_Id']]); ?>',600,400)" href="javascript:;">
