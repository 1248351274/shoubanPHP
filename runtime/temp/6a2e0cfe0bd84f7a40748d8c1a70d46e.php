<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\yanqingProTool\PHPTutorial\WWW\wxshop/application/index\view\img\typedit.html";i:1528954555;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="x-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="GT_Type" name="GT_Type" value="<?php echo $msg['GT_Type']; ?>" required="" 
                        autocomplete="off" class="layui-input">
                    </div>
                    <input type="hidden" id="GT_Id" value="<?php echo $msg['GT_Id']; ?>">
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">图片</label>
                        <img src="<?php echo $msg['GT_Image']; ?>" id="img" style="width: 100px;height: 100px" alt="无图片">
...
<script>
    ...
    $('#editbtn').click(function(){
        ...
        $.ajax({
            type:"POST",
            dataType:"json",
            url:"<?php echo url('index/Img/editype'); ?>",
            data:{GT_Id:$('#GT_Id').val(),GT_Type:$('#GT_Type').val(),GT_Image:$('#img').attr('src')},
            // data:$('#form').serialize(),
            success:function(data){
                if(data==1){
