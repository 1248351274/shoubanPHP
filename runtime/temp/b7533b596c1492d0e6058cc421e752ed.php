<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\yanqingProTool\PHPTutorial\WWW\wxshop/application/index\view\goods\shlist.html";i:1556070534;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="x-nav">
      ...
      <div class="x-body">
        ...
        <xblock>
          <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量审核</button>
    ...
    function delAll(){
        ...
        layer.confirm('确认要审核吗？',function(index){
            ...
            $.ajax({
                type:"POST",
                dataType:"json",
                url:"<?php echo url('index/Goods/shall'); ?>",
                data:{id:data},
