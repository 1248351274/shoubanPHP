<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"C:\Users\Administrator\Desktop\work\wxshop/application/index\view\admin\edit_show.html";i:1529316171;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form" id="form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="Admin_Name" name="Admin_Name" value="<?php echo $msg['Admin_Name']; ?>" required="" 
                        autocomplete="off" class="layui-input">
                    </div>
                    <input type="hidden" id="Admin_Id" name="Admin_Id" value="<?php echo $msg['Admin_Id']; ?>">
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">
...
<script>
    $('#editbtn').click(function(){
        ...
        $.ajax({
            type:"POST",
            dataType:"json",
            url:"<?php echo url('index/Admin/edit'); ?>",
            data:$('#form').serialize(),
